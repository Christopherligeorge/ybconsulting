...
export const appRouter = router({
  authCallback: publicProcedure.query(async () => {
    ...
    //originally user = getUser(), add an await return await handleAuth(request, endpoint); on src/app/api/auth/[kindeAuth]/route.js.
    ...
    //dbUser is user in the db, not the same as the const user = getuser() defined.
